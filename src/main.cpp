...
int main(int argc, char **argv)
{
	...
	int generateImage = 0;
	if ((argc == 2)||1) //entra sempre
	{
		//filePath = argv[1];
		filePath = "C:\\Users\\Riccardo\\Desktop\\3Anno\\Multimedia\\Cuda\\average_filter\\average_filter\\Osaka_Castle.jpg";
	...
	const double cpuTime = stats_cpu->getAvg(stats_cpu);
	const double gpuTime = stats_gpu->getAvg(stats_gpu);
	printf("Speedups\n");
	printf("GPU        : %6.2f \n", cpuTime / gpuTime);
